...
I'm The Elite Music Bot! A Powerful Bot to Play Music in Your Group Voice Chat 😇!

Also I have more features! Please hit on **/help** to see them 😘!

Made with ❤️ **@Xmarty_Updates**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        "Source Code 📦", url="https://github.com/S780821/ELITE_MUSIC_BOT"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "Channel ️", url=f"https://t.me/Xmarty_Updates"
                    ),
                    InlineKeyboardButton(
                        "Support Group ⚜️", url="https://t.me/Xmarty_Support"
                    )
                ]
            ]
        )
...
**Supported Url List:** @Xmarty_Support

Made with ❤️ by **@Xmarty_Updates**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
